...
export default defineComponent({
  ...
  mounted() {
    numberFormats.forEach((element) => {
      numberName.push(element.name);
  ...
  setup() {
    ...
    const optionsNumber = ref(numberFormats);
    ...
    return {
      ...
      filterFn(val, update) {
        update(() => {
          if (val === "") {
            optionsNumber.value = numberFormats;
          } else {
            const needle = val.toLowerCase();
            optionsNumber.value = numberFormats.filter(
